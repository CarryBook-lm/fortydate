...
function MonProfil({ moi, onDeconnexion, onMaj }) {
  ...
  return (
    <div className="fdh-profil">
      ...
      {/* Album */}
      <h3 className="fdh-album-titre">Mes photos <span>{album.length}/9</span></h3>
        ...
        {etat === 'ok' ? (
          ...
          <>
            ...
            <button className="fdh-btn-rose" style={{ width: '100%', marginTop: '1rem' }} onClick={payer}>
              📱 Mobile Money (Cameroun) · {plan.prix.toLocaleString('fr-FR')} FCFA
            </button>
            <button className="fdh-btn-outline" style={{ width: '100%', marginTop: '.5rem' }} onClick={payerChariow}>
              💳 Carte / autre pays · {plan.prix.toLocaleString('fr-FR')} FCFA
            </button>
            <div className="fdh-momo">
              <img src="data:image/png;base64," alt="MoMo MTN" />
              <img src="data:image/png;base64," alt="Orange Money" />
            </div>
            <p className="fdh-abo-note">Mobile Money via CamPay · Carte &amp; Afrique via Chariow</p>
          </>
        )}
      </div>
    </div>
