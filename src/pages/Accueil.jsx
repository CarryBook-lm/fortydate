...
function Proximite({ moi, onVoir }) {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        const { data, error } = await requeteCandidats(moi, 'id, prenom, date_naissance, photo_principale')
      ...
      <div className="fdh-modal" onClick={e => e.stopPropagation()}>
        ...
        {etat === 'ok' ? (
          ...
          <>
            ...
            <p className="fdh-abo-note">Paiement sécurisé par CamPay · MTN MoMo & Orange Money</p>
          </>
        )}
      </div>
    </div>
